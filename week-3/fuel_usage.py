...
file: fuel_usage.py
Purpose: Check your understanding of writing your own functions with parameters and then calling those functions with arguments.
...
def main():
    ...
    mpg = miles_per_gallon(start_miles, end_miles, fuel_used)

...
def count_genders(people_dict):
    ...
    for person in people_dict:
        ...
        gender = people_dict[person][GENDER_INDEX]
        ...
        if gender == "M":
            ...
            print("Not a valid gender abbreviation.")
...
def print_marriages(marriages_dict, people_dict):
    ...
    for marriage in marriages_dict:
        ...
        marriage_year = marriages_dict[marriage][WEDDING_YEAR_INDEX]

        husband_id = marriages_dict[marriage][HUSBAND_KEY_INDEX]
        husband_name = people_dict[husband_id][NAME_INDEX]
        husband_birth_year = people_dict[husband_id][BIRTH_YEAR_INDEX]
        husband_age_wedding = marriage_year - husband_birth_year

        wife_id = marriages_dict[marriage][WIFE_KEY_INDEX]
        wife_name = people_dict[wife_id][NAME_INDEX]
        wife_birth_year = people_dict[wife_id][BIRTH_YEAR_INDEX]
        wife_age_wedding = marriage_year - wife_birth_year

        print(f"{husband_name} {husband_age_wedding} > {marriage_year} < {wife_name} {wife_age_wedding}")
